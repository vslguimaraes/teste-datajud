...
// Códigos da Tabela Processual Unificada do CNJ, usados para derivar a
// SITUAÇÃO do processo. O resumo da linha do tempo não passa mais por aqui:
// ver fases.ts.
const COD_BAIXA = new Set([22]);
const COD_JULGAMENTO = new Set([193, 196, 198, 219, 220, 221, 237, 385, 461, 471, 11795]);
